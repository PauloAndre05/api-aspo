/*
  ...
  - Changed the type of `servicoId` on the `agendamentos` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
-- AlterTable
ALTER TABLE "agendamentos" DROP COLUMN "servicoId",
